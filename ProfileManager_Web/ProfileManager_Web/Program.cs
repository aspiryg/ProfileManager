...
using ProfileManager_Web.Client.Pages;
using ProfileManager_Web.Components;
using ProfileManager_Web.Components.Account;
...
app.MapRazorComponents<App>()
    ...
    .AddAdditionalAssemblies(typeof(ProfileManager_Web.Client._Imports).Assembly);
